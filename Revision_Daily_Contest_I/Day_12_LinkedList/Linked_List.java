package Basic_To_Advanced_DataStructure.Revision_Daily_Contest_I.Day_12_LinkedList;
...
public class Linked_List {
    ...
    /**
     * Node Class:- Using the below class simple node has been created
     */
    static class Node {
        int data;
        Node next;
